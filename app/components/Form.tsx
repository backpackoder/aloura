...
export function Form() {
  return (
    <article className="bg-gray-50 rounded-lg mt-8">
      <h2 className="text-3xl font-medium text-center py-5 px-1 rounded m-2">📞 Nous réserver</h2>

      <section className="flex flex-col gap-4 p-8">
        <p className="text-center">
          Vous souhaitez nous réserver pour un événement privé ou professionnel ?
          <br />N{"'"}hésitez pas à nous contacter pour nous faire part de votre projet.
        </p>

        <div className="max-w-screen-sm bg-white p-8 rounded-lg shadow-lg">
